...
class GoogleMapsApi:
    ...
    def create_new_place():
        ...
        with allure.step(f"Method for creating a new location"):
    ...
    def get_new_place(place_id):
        ...
        with allure.step(f"Method for get a location"):
    ...
    def put_new_place(place_id, address):
        ...
        with allure.step(f"Method for changing the location"):
    ...
    def delete_new_place(place_id):
        ...
        with allure.step(f"Method for deleting a location"):
